...
class GPT2Tokenizer:
    ...
    def __init__(
        self, vocab_file: Optional[str] = None, merges_file: Optional[str] = None
    ):
        self.pad_token = "<pad>"
        self.bos_token = "<bos>"
        self.eos_token = "<eos>"
    ...
    def encode(self, text: str, add_special_tokens: bool = True) -> List[int]:
        ...
        if add_special_tokens:
            token_ids = (
                [self.vocab[self.bos_token]] + token_ids + [self.vocab[self.eos_token]]
            )
    ...
    def from_pretrained(cls, model_name: str = "gpt2"):
        ...
        try:
            ...
            hf_tokenizer = HFGPT2Tokenizer.from_pretrained(
            ...
            tokenizer.unk_token_id = (
                hf_tokenizer.unk_token_id if hf_tokenizer.unk_token_id is not None else 3
            )
            ...
            print("警告: 无法加载本地transformers分词器，使用简化分词器")
            return cls()
...
class CharTokenizer:
    ...
    @classmethod
    def from_file(cls, vocab_path: str):
    ...
    def save(self, vocab_path: str):
        with open(vocab_path, "w", encoding="utf-8") as f:
            json.dump({"type": "char", "vocab": self.vocab}, f, ensure_ascii=False, indent=2)
