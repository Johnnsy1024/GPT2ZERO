...
class GPT2LMHeadModel(nn.Module):
    ...
    def forward(
        ...
        torch.Tensor, Optional[torch.Tensor], Optional[Tuple[Tuple[torch.Tensor]]]
    ]:
    ...
    def generate(
        ...
        **kwargs,
        ...
        if num_return_sequences < 1:
            raise ValueError("num_return_sequences 必须大于等于 1")
...
if __name__ == "__main__":
    ...
    print(
        f"Past key values长度: {len(past_key_values) if past_key_values is not None else 0}"
    )
